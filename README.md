# Pomoć kod izvršitelja

Prva javna verzija sajta za ljude koji imaju problem sa izvršenjem, blokiranim računom, obustavom na plati ili penziji, dugom koji ne prepoznaju ili popisom imovine.

## Trenutna verzija

Ovo je početna landing stranica i vizuelna osnova za kasniju aplikaciju. Trenutno nema prijavu, slanje dokumenata, naplatu ni čuvanje predmeta. Konačni kontakt podaci i domen dodaju se pre prebacivanja na Lopiju.
...
Radni projekat je spreman za povezivanje sa GitHub repozitorijumom. Ne čuvati tokene, lične podatke ni dokumenta korisnika u repozitorijumu.
