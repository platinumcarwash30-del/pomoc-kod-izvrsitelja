    ...
    <main className="min-h-screen bg-[#f7f8fa] text-slate-950">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 sm:px-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm font-bold text-slate-700 transition hover:text-red-700"
          >
          ...
          <div className="flex items-center gap-2 text-sm font-bold tracking-tight text-slate-950">
            <Scale className="size-5 text-red-600" /> Pomoć kod izvršitelja
          </div>
        </div>
      </header>
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-5 pb-20 pt-12 sm:px-8 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20 lg:pb-28 lg:pt-20">
        <aside className="max-w-sm">
          ...
          <h1 className="mt-4 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl">
            Hajde prvo da razumemo šta vam se dešava.
          </h1>

          <p className="mt-5 text-base leading-7 text-slate-600">
            Odgovorite na nekoliko kratkih pitanja. Ne morate znati pravni naziv
            problema i ne šaljite osetljive dokumente u ovom koraku.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-600">
                  Ovaj početni pregled je samo orijentacija. Bez slanja i čuvanja
                  dokumenata.
                </p>
              </div>
            </div>
        ...
        <section className="min-w-0">
          ...
          <div
            className="mb-8 h-2 overflow-hidden rounded-full bg-slate-200"
            aria-label={`Napredak: korak ${step} od 3`}
          >
            <div
            ...
            {completed ? (
              <div className="py-8 text-center sm:py-14">
                ...
                <h2 className="mt-3 text-3xl font-semibold tracking-[-0.04em]">
                  Uspešno ste poslali zahtev za pregled Vašeg problema.
                </h2>

                <p className="mx-auto mt-4 max-w-md text-base leading-7 text-slate-600">
                  Očekujte odgovor u roku od 24h. Zbog prevelikog broja zahteva
                  koji dobijamo, ukoliko Vas niko ne kontaktira u tom vremenskom
                  intervalu, pozovite nas na broj{" "}
                  <a
                    href="tel:+381637572520"
                    className="font-semibold text-slate-900 underline decoration-red-300 underline-offset-4 transition hover:text-red-700"
                  >
                    +381 63 757 2520
                  </a>
                  .
                ...
                <Link
                  href="/#kontakt"
                  className="mt-8 inline-flex items-center gap-3 rounded-full bg-slate-950 px-6 py-3.5 text-sm font-bold text-white transition hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2"
                >
                  Nastavite ka razgovoru <ArrowRight className="size-4" />
                </Link>
              </div>
            ) : (
              <>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h2 className="text-2xl font-semibold tracking-[-0.03em]">
                          Šta vam se trenutno dešava?
                        </h2>

                        <p className="mt-2 text-sm leading-6 text-slate-600">
                          Izaberite ono što je najbliže vašoj situaciji.
                        </p>
                      </div>
                    </div>
                      ...
                      {problemOptions.map((option) => {
                        ...
                        return (
                          <button
                            ...
                            onClick={() => setProblem(option.title)}
                            className={`group rounded-2xl border p-4 text-left transition focus:outline-none focus:ring-2 focus:ring-red-300 ${
                              selected
                ...
                {step === 2 && (
                  <div>
                    <div className="flex items-start gap-4">
                      <div className="grid size-12 shrink-0 place-items-center rounded-2xl bg-amber-50 text-amber-700">
                        <Clock3 className="size-5" />
                      </div>

                      <div>
                        <h2 className="text-2xl font-semibold tracking-[-0.03em]">
                          Koliko je situacija hitna?
                        </h2>

                        <p className="mt-2 text-sm leading-6 text-slate-600">
                          Izabrali ste: <strong>{problem}</strong>. Sada nam
                          pomozite da razumemo trenutak u kom se nalazite.
                        </p>
                      </div>
                    </div>
                      ...
                      {urgencyOptions.map((option) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex w-full items-center justify-between rounded-2xl border p-4 text-left text-base font-semibold transition focus:outline-none focus:ring-2 focus:ring-red-300 ${
                              selected
                ...
                {step === 3 && (
                  <div>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h2 className="text-2xl font-semibold tracking-[-0.03em]">
                          Evo šta smo za sada razumeli.
                        </h2>

                        <p className="mt-2 text-sm leading-6 text-slate-600">
                          Proverite da li je ovaj sažetak tačan pre nego što
                          nastavite.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-8 divide-y divide-slate-200 rounded-2xl border border-slate-200 bg-slate-50">
                      <div className="flex items-start justify-between gap-4 p-4">
                        ...
                        <strong className="text-right text-sm">{problem}</strong>
                      </div>
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-2">
                      <label className="text-sm font-bold text-slate-700">
                        ...
                        <input
                          ...
                          className="mt-2 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 font-normal outline-none transition placeholder:text-slate-400 focus:border-red-500 focus:ring-2 focus:ring-red-100"
                        />
                      </label>
                    ...
                    <div className="mt-5 flex gap-3 rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm leading-6 text-blue-950">
                      <ShieldCheck className="mt-0.5 size-5 shrink-0 text-blue-600" />
                      <p>
                        Ne šaljite JMBG, broj računa ili kompletna rešenja dok
                        ne dogovorimo bezbedan kanal.
                      </p>
                    </div>
                ...
                <div className="mt-9 flex flex-col-reverse gap-3 border-t border-slate-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <button
                    ...
                    disabled={
                      isSubmitting ||
                      (step === 1 ? !problem : step === 2 ? !urgency : false)
                    }
                    onClick={goNext}
                    className="inline-flex items-center justify-center gap-3 rounded-full bg-red-500 px-6 py-3.5 text-sm font-bold text-white shadow-[0_12px_28px_rgba(239,68,68,0.2)] transition hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-40 focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2"
                  >
                    {step === 3
                      ? isSubmitting
                        ? "Šaljemo zahtev..."
